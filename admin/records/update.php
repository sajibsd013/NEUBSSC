    ...
    <div class="admin_root">
        ...
        if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] == true && isset($_GET['p'])) {
            ...
            if ($user_type == "admin") {
                ...
                $existsql = "SELECT * FROM `records` WHERE `RecordID` = '$RecordID'";
        ...
        ?>
                ...
                <div class="row justify-content-center g-3 my-2 ">
                    <div class="col-lg-6 col-md-9  bg-white shadow-lg rounded p-4">
                        <h3 class="heading_color mb-4">Update Records</h3>
                        <form onsubmit="submitForm(event,'<?php echo $action_url ?>')">
                        <input type="text" class="form-control _form_data d-none" id="RecordID" name="RecordID" value="<?php echo $RecordID ?>" placeholder=" " required>
                            ...
                            <button type="submit" id="submit" class="btn btn-dark btn-sm my-3 w-100 fw-bold">Update Records</button>
                        </form>

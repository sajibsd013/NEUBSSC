...
<div id="SideNavID" class="sideNav NavOpen mt-5 bg-white border">
    <div class="_nav_top">
        ...
        <a class="nav-menu-item pointer" " onclick=" redirectTo('<?php echo $root_url ?>/admin/committee/')">
            <i class="fa fa-users m-2" aria-hidden="true"></i>Committee
        </a>
        <a class="nav-menu-item pointer" " onclick=" redirectTo('<?php echo $root_url ?>/admin/records/')">
